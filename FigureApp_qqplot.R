...
#
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 	Global null: run simulation, with estimated variance
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
for (rep in 1:reps) {
  ...
  for (k in seq(1, r)) {
    ...
    # Choi p-value
    choi_pvalue <- choi_test_pvalue(vals, k=k, n=n, p=p, sigma=sigma_hat, eigen=eigen)
...
save(results_df, file="data/elbow-power-global_null-var_est=TRUE.RData")
...
load("data/elbow-power-global_null-var_est=TRUE.RData")
...
print(g)
ggsave(paste0('./figures/FigureApp_qqplot_elbow-var_est=TRUE.png'), width = 5, height = 2, unit = "in")
